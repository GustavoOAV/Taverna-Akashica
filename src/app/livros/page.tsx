      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <section className="w-full h-[250px] md:h-[400px] bg-[url('/images/bg-stars.png')] bg-cover bg-center bg-no-repeat flex flex-col items-center relative shadow-xl">
          <div className="absolute top-6 left-6 z-50">
            <Link href="/" className="text-akashic-gold font-cinzel text-sm md:text-base hover:text-cyan-400 transition-colors flex items-center gap-2 opacity-80 hover:opacity-100">
              ← Voltar ao Início
            </Link>
          </div>
          <div className="absolute bottom-0 translate-y-[10%] left-1/2 -translate-x-1/2 w-full max-w-[80%] md:max-w-2xl flex justify-center z-30">
            <Image src="/images/main-logo.png" alt="Taverna Akashica - Biblioteca" width={600} height={400} priority className="drop-shadow-[0_0_35px_rgba(0,240,255,0.4)] object-contain" />
          </div>
        </section>
